...
const PostsList = () => {
  ...
  const reactUrl = process.env.REACT_IP
  console.log(reactUrl)
  
  const getDynamicURL = () => {
    // Your logic to determine the URL dynamically
    return `/api/users/blog`; // Update this with your dynamic URL
  };
  ...
  if (postStatus === "loading") {
    ...
    content = (
      <div>
        <div className="  w-10/12 md:pl-64 pl-12 text-secondery font-primaryFont text-start font-bold items-center md:text-l lg:text-xl text-sm  ">
